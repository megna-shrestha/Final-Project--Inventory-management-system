    ...
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#" style="padding:0px;">
          ...
          <div class="col-md-2">
            <img src="ilogo.png" alt="" width="50px" height="50px">

          </div>
          <div class="col-md-10 " id="heading3" name="heading3">
            <h4><b>Sales and Inventory System</h4>
          </div>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <?php if (isset($_SESSION['userId']) && $_SESSION['userId'] == 1) { ?>
            <li id="navPreferences"><a href="Customerp.php"> <i class="glyphicon glyphicon-ruble"></i> Preferences </a></li>
          <?php } ?>

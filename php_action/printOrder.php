...
<table align="center" cellpadding="0" cellspacing="0" style="width: 100%;border:1px solid black;margin-bottom: 10px;">
               <tbody>
                  ...
                  <tr>
                     <td colspan="3" style="font-style: italic;font-weight: ;text-decoration: underline;font-size: px;">Simple Inventory System</td>
                  </tr>
                  <tr>
                     <td colspan="3" >Hadigaun,</td>
                  </tr>
                  <tr>
                     <td colspan="3" >Kathmandu,35021</td>
                  </tr>
                  <tr>
                     <td colspan="3" >Tele: 01-4412317, 9841410352</td>
                  </tr>
                  <tr>
                     <td colspan="3" >Email: email0@email.com</td>
                  </tr>
                  <tr>
                     <td colspan="3" style="text-decoration: underline;">email0@email.com</td>
                  </tr>
                  <tr>
                     ...
                     <td style="padding: 0px;vertical-align: top;" colspan="3">
                        <table align="left" cellpadding="0" cellspacing="0" style="width: 100%">
                           <tbody>
                              <tr>
                                 <td style="border-bottom-style: solid;border-bottom-width: thin;border-bottom-color: black;border-top: 1px solid black;border-right: 1px solid black;">Bill No : 012566112</td>
                              </tr>
                              <tr>
                  ...
                  <tr>
                     <td style="width: 123px;text-align: center;background-color: black;color: white;border-right: 1px solid white;border-left: 1px solid black;border-bottom: 1px solid black;-webkit-print-color-adjust: exact;"> Product no.
                     </td>
...
$table .= '
                  ...
                  <tr>
                     <td colspan="3" style="border-top: 1px solid black;border-bottom: 1px solid black;border-left: 1px solid black;padding: 5px;">Bank Name:- Nepal Investment Mega Bamk</td>
                     <td rowspan="2" style="border-bottom: 1px solid black;width: 199px;color: white;background-color: black;padding-left: 5px;-webkit-print-color-adjust: exact;">(Vat + Service charge)18%: </td>
                     <td rowspan="2" style="border-bottom: 1px solid black;width: 288px;border-right: 1px solid black;">' . $vat . '</td>
                  </tr>
                  <tr>
                     <td colspan="3" style="border-bottom: 1px solid black;width: 859px;border-left: 1px solid black;padding: 5px;">Branch:- Sifal, Kathmandu</td>
                  </tr>
                 
                  <tr>
                     <td colspan="3" style="border-bottom: 1px solid black;border-left: 1px solid black;padding: 5px;">AC. HO. Name:- All in one store</td>
                     <td style="border-bottom: 1px solid black;background-color: black;color: white;padding: 5px;-webkit-print-color-adjust: exact;">Total (rs): </td>
                     <td style="border-bottom: 1px solid black;border-right: 1px solid black;">' . $totalAmount    . '</td>
                  </tr>
                  <tr>
                     <td colspan="3" style="border-bottom: 1px solid black;border-left: 1px solid black;padding: 5px;">AC.NO. :- 256412357895411</td>
                     <td style="border-bottom: 1px solid black;background-color: black;color: white;padding: 5px;-webkit-print-color-adjust: exact;">Discount (rs): </td>
                  ...
                  <tr>
                     ...
                     <td style="border-bottom: 1px solid black;border-right: 1px solid;">Rs. ' . $grandTotal . '</td>
                  </tr>
                  <tr>
                     <td colspan="3" style="border-left: 1px solid black;border-bottom: 1px solid black;padding: 5px;border-right: 1px solid black;">* Inclusive of Vat and Service charge.</td>
